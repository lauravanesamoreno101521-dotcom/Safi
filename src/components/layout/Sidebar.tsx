...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="hidden lg:flex flex-col h-full py-6 px-3 gap-2 bg-[#f3e7d0] border-r border-[#ddc9a3] w-64 shrink-0 shadow-xs z-30 select-none">
      {/* Brand & Sede badge */}
      <div className="flex flex-col gap-1 mb-6 px-3">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-[#7a0d0a] text-white flex items-center justify-center shadow-md">
            <Store className="w-6 h-6" />
          </div>
          <div>
            <p className="font-bold text-sm text-[#7a0d0a] leading-tight">Caja Principal</p>
            <p className="text-[10px] text-[#7a6552] uppercase tracking-widest font-bold">Sede Norte</p>
          </div>
        </div>
      </div>
